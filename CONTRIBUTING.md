...
issue](https://github.com/cisagov/ansible-role-disable-thp/issues) in
...
request](https://github.com/cisagov/ansible-role-disable-thp/pulls), you
...
```console
cd ansible-role-disable-thp
pyenv virtualenv <python_version_to_use> ansible-role-disable-thp
pyenv local ansible-role-disable-thp
